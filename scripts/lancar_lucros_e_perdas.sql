...
select pl.date_sell,
           'income',
           ROUND((pl.quantity * value)::numeric, 2),
           ticker,
           null,
           'B3',
...
select pl.date_sell,
           ...
           null,
           'B3',
           'Lucro referente a venda de '|| pl.quantity || ' cotas de ' || s.name || ' no preço de venda de ' || usm.price || ' Reais',
           1,
           usm.date,
           'Lucro investimentos',
           pl.id || '_' || usm.id,
...
select pl.date_sell,
           ...
           null,
           'B3',
           'Prejuízo referente a venda de '|| pl.quantity || ' cotas de ' || s.name || ' no preço de venda de ' || usm.price || ' Reais',
           1,
           usm.date,
